...
#show: rendercv.with(
  name: "Bruno Pumapillo Sarmiento",
  footer: context { [#emph[Bruno Pumapillo Sarmiento -- #str(here().page())\/#str(counter(page).final().first())]] },
...
#connections(
  [Lima, Perú],
  [#link("mailto:thulobruno@gmail.com", icon: false, if-underline: false, if-color: false)[thulobruno\@gmail.com]],
  [#link("tel:+51-916-223-067", icon: false, if-underline: false, if-color: false)[916 223 067]],
  [#link("https://brun0west.github.io/Brun0West/", icon: false, if-underline: false, if-color: false)[brun0west.github.io\/Brun0West]],
  [#link("https://linkedin.com/in/bruno-pumapillo-sarmiento", icon: false, if-underline: false, if-color: false)[linkedin.com\/in\/bruno-pumapillo-sarmiento]],
  [#link("https://github.com/Brun0West", icon: false, if-underline: false, if-color: false)[github.com\/Brun0West]],
)
